...
| 17a | `S-E-enterprise-readiness.md` | **DRAFT** — what a top-tier studio (Amazon MGM, Apple, A24, Marvel, Netflix) requires before unreleased footage touches this platform. **Every claim is tagged [SOURCED] / [CODE] / [DOMAIN] / [OPEN]** — three of five research streams did not complete and the document says so. Do not promote a [DOMAIN] claim by quoting it. Headline: **the binding gate is MPA/TPN content security, not SOC 2** — a separate org with a separate veto |
