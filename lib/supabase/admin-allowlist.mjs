 ...
 *   · `no-restricted-syntax` on SUPABASE_SERVICE_ROLE_KEY — the two handlers
 *     that construct their own client inline and so import nothing
 *     (create-client:46, resend-invite:37), plus anything new that tries.
 *
